# Generated by Django 2.2.3 on 2019-09-08 13:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Redirect',
            fields=[
                ('from_url', models.CharField(db_index=True, help_text="Absolute path, excluding the domain. Example: '/about/'", max_length=255, primary_key=True, serialize=False, unique=True, verbose_name='From URL')),
